...
<%
    ...
    if (id != null && name != null && email != null) {
        ...
        if (companyDAO.updateCompany(c)) {
            response.sendRedirect("superadmin_companies.jsp?success=updated");
        } else {
            response.sendRedirect("superadmin_companies.jsp?error=update_failed");
        }
    } else {
        response.sendRedirect("superadmin_companies.jsp?error=missing");
    }
%>
